...
//PUNTOS EXTREMO NO CONVIENE QUE SEA EL NODO PADRE
using std::vector;
...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux(1.0);//Inicializar matriz de Modelo 4x4 TRANSFORMACIONE SQUE SI QUIERO HEREDAR
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f)); //TECLADO QUE CON LA TECLA F ROTA LOS EJES
		modelaux = model;
...
//lAS LLANTAS TIENEN UN EJE
//CABINA NODO PADRE, MUEVE A LA BASE Y TIENE CUATRO PUNTOS, LA CABINA SE DUBUJA PRIMERO
