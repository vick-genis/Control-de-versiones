...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = modelaux;
		//DIBUJANDO LLANTAS EJERCICIO 1
		//Llanta derecha frente
		//model = glm::mat4(1.0);
		color = glm::vec3(0.7f, 0.7f, 1.0f);
		modelaux = model;
		model = glm::translate(model, glm::vec3(1.8f, 4.2f, -3.5f));
		...
		//model = glm::mat4(1.0);
		color = glm::vec3(0.4f, 0.4f, 0.7f);
		modelaux = model;
		model = glm::translate(model, glm::vec3(1.8f, 4.2f, -4.7f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.5f, 0.8f));
		...
		model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.5f, 0.8f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 1.0f, 0.0f)); //SE MUEVE CON LETRA O
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		model = modelaux;
		...
		model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.5f, 0.8f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 1.0f, 0.0f)); //SE MUEVE CON LETRA P
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		model = modelaux;
		...
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		// Obtener el ángulo de rotación desde la ventana (supongamos que es en grados)
		//float rotationAngle = mainWindow.getarticulacion4();

		// Limitar el ángulo de rotación entre un rango específico, por ejemplo, de -45 a 45 grados
		//rotationAngle = glm::clamp(rotationAngle, -90.0f, 90.0f);
		// Aplicar la rotación solo alrededor del eje Y (rotación de izquierda a derecha)
		...
		*/
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		sp.render();
		model = modelaux;//descarta lo que hereda

		//OREJAS
		//Oreja derecha
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.7f, 5.5f, -4.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.3f));
		//color = glm::vec3(1.7f, 0.6f, 0.5f);
		color = glm::vec3(0.7f, 0.6f, 0.5f);
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.7f, 5.5f, -3.9f));
		...
		//OJO IZQUIERDO
		modelaux = model;
		model = glm::translate(model, glm::vec3(-0.4f, 4.5f, -3.0f));
		...
		//NARIZ
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, 4.0f, -2.9f));
		model = glm::scale(model, glm::vec3(0.1f, 0.1f, 0.05f));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(0.4f, 0.5f, 0.05f));
		color = glm::vec3(1.0f, 1.0f, 1.0f);
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));//FALSE ES PARA QUE NO SEA TRANSPUESTA
		...
		//BOCA
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, 3.9f, -2.9f));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.05f));
		color = glm::vec3(1.7f, 0.6f, 0.5f);
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		//model = glm::rotate(model, glm::radians(85.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//articulación 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.05f, 2.0f, -4.0f));
		//model = glm::translate(model, glm::vec3(0.0f, 6.0f, -4.0f));
		//rotación alrededor de la articulación que une con la cabina
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		// Obtener el ángulo de rotación desde la ventana (supongamos que es en grados)
		float rotationAngle = mainWindow.getarticulacion3();
		// Limitar el ángulo de rotación entre un rango específico, por ejemplo, de -45 a 45 grados
		rotationAngle = glm::clamp(rotationAngle, -45.0f, 10.0f);
		// Aplicar la rotación solo alrededor del eje Z (rotación en el plano XY)
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.4f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7f, 0.6f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular
		...
		// Obtener el ángulo de rotación desde la ventana (supongamos que es en grados)
		float rotationAngle1 = mainWindow.getarticulacion6();
		// Limitar el ángulo de rotación entre un rango específico, por ejemplo, de -45 a 45 grados
		rotationAngle1 = glm::clamp(rotationAngle1, -45.0f, 10.0f);
		// Aplicar la rotación solo alrededor del eje Z (rotación en el plano XY)
		model = glm::rotate(model, glm::radians(rotationAngle1), glm::vec3(0.0f, 0.0f, -1.0f));
